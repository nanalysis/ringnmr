 ...
 * @author brucejohnson
 */
public class MFModelIsoD1 extends MFModelIso {

    double sf2;

    public MFModelIsoD1(boolean fitTau, double targetTau, double tauFraction,
                        boolean includeEx) {
        super(fitTau, targetTau, tauFraction, includeEx);
        nPars = includeEx ? 2 : 1;
    }

    public MFModelIsoD1(double targetTau) {
    ...
    public double[] calc(double[] omegas) {
        ...
        for (double omega : omegas) {
            ...
            J[j++] = 0.4 * sf2p * tauMx / (1.0 + omega2 * tauMx * tauMx);
        }
        return J;
    }
