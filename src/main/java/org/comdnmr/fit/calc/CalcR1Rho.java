...
public class CalcR1Rho extends FitModel {
    ...
    public CalcR1Rho(double[][] x, double[] y, double[] err, double[] fieldValues, double[] fields) throws IllegalArgumentException {
        this(x, y, err, fieldValues, fields, new int[x.length]);
    }

    public CalcR1Rho(double[][] x, double[] y, double[] err, double[] fieldValues, double[] fields, int[] idNums) throws IllegalArgumentException {
