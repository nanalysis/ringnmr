...
public interface EquationFitter {
    ...
    public default CPMGFitResult getResults(EquationFitter fitter, String eqn, String[] parNames, String[] resNums, int[][] map, int[][] states, double[] usedFields, int nGroupPars, double[] pars, double[] errEstimates, double aic, double rms, double[][] simPars, boolean hasExchange) {
...
//            System.out.println("res " + resNums[states[iCurve][0]] + " " + parValues.toString());
        ...
        CPMGFitResult fitResult = new CPMGFitResult(parNames, curveFits, eqn, nGroupPars, aic, rms, simsMap, hasExchange);
        return fitResult;
    }
}
