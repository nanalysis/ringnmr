 ...
 * @author brucejohnson
 */
public class MFModelAniso2 extends MFModelAniso1 {

    double tauF;

    public MFModelAniso2(RelaxFit.DiffusionType diffType, double[][] D, double[][] VT, double[] v) {
    ...
    public double[] getStart(double targetTau) {
        ...
        return getParValues(targetTau, 0.9, targetTau / 40.0);
    }

    @Override
    public double[] getLower() {
        return getParValues(targetTau / 10., 0.0, targetTau / 1000.0);
    }

    @Override
    public double[] getUpper() {
        return getParValues(targetTau * 10., 1.0, targetTau / 10.0);
    }
