...
public class CESTFitTest {
    ...
    public void testcestR1rhoPerturbation() {
        ...
        CPMGFitResult fit = fitting.doFit("cestr1rhoperturbation", false, false, null, false);
...
//        Assert.assertArrayEquals(fitpars, validpars, 6.0e-13);
    ...
    public void testcestR1rhoSD() {
        ...
        CPMGFitResult fit = fitting.doFit("cestr1rhosd", false, false, null, false);
...
//            System.out.println("err * 3 = " + fiterrs[i]*3);
    ...
    public void testcestR1rhoBaldwinKay() {
        ...
        CPMGFitResult fit = fitting.doFit("cestr1rhobaldwinkay", false, false, null, false);
...
//            System.out.println("err * 3 = " + fiterrs[i]*3);
    ...
    public void testcestR1rhoN() {
        ...
        CPMGFitResult fit = fitting.doFit("cestr1rhon", false, false, null, false);
